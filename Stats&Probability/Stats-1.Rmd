...
data points prices between 624:768
```{r}
mean = 16.3
std = 2
data_point = 14.9 # 12.9 ,14.9
...
# what proportion is lower than data point?
z_score = (data_point - mean) / std
paste('z score: ', round(z_score,4), 'std from the mean')
...
# z score for data point 1 = -1.7   -->> look at z-table
z_1 = 0.04457

# z score for data point 2 = -0.7
z_2 = 0.242
